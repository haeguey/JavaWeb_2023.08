        ...
        <div class="row">
			...
			<div class="col-9">
                ...
                <div class="row">
                	<div class="col-1"></div>
                	<div class="col-10">
                		<form action="/myProject/blog/update" method="post">
							<input type="hidden" name="blogId" value="${blog.blogId}">
	                			...
	                			<tr>
	                				<td colspan="2" style="text-align: center;">
	                					...
	                					<input class="btn btn-secondary" onclick="location.href='/myProject/blog/detail/${blogId}?option=DNI'" type="reset" value="Cancel">
	                				</td>
	                			</tr>
	                		</table>
						</form>
