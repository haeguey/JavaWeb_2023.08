...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
        <div class="container-fluid">
            <img src="/myProject/img/ck-logo.png" alt="Logo" style="height:60px;" class="rounded-3 mx-2">
    ...
    <div class="container" style="margin-top: 250px;">
        <div class="row">
            ...
            <div class="col-4">
            	...
            	<hr>
	            <form action="/myProject/user/register" method="post" enctype="multipart/form-data">
