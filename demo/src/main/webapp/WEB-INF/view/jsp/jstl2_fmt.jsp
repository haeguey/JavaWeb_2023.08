...
<body style="margin: 40px;">
	...
	<hr>
		<table border="1">
			...
			<tr><td>퍼센트</td>
				<td><fmt:formatNumber type="percent" value="${price / 1000000000}" /></td></tr>
			<tr><td></td><td></td></tr>
			...
			<tr><td>pattern("YYYY-MM-dd HH:mm:ss")</td>
				<td><fmt:formatDate type="date" pattern="YYYY-MM-dd HH:mm:ss" value="${now}" /></td></tr>
			<tr><td>pattern("YYYY-MM-dd HH:mm:ss")</td>
				<td><fmt:formatDate type="date" pattern="YYYY-MM-dd HH:mm" value="${now}" /></td></tr>
				<tr><td></td><td></td></tr>
